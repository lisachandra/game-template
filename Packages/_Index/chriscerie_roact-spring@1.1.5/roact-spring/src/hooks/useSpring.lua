...
if isRoact17 then
    exports = function<T>(props: Controller.ControllerProps<T> | () -> Controller.ControllerProps<T>, deps: { unknown }?): any
    ...
    exports = function<T>(hooks: { [string]: any }, props: Controller.ControllerProps<T> | () -> Controller.ControllerProps<T>, deps: { unknown }?): any
        if type(props) == "function" then
